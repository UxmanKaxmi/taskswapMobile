...
export function getTitle(type: GoalType): string {
  switch (type) {
    case 'motivation':
...
export function getSubtitle(type: GoalType): string {
  switch (type) {
    case 'motivation':
...
export function getGoalPlaceholder(type: GoalType): string {
  switch (type) {
    case 'motivation':
...
export function getGoalHints(type: GoalType): string {
  switch (type) {
    case 'motivation':
...
export function getHelperHints(type: GoalType): string {
  switch (type) {
    case 'motivation':
...
export function getButtonText(type: GoalType): string {
  switch (type) {
    case 'motivation':
