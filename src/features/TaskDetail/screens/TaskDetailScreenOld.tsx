...
import CommentsSection from '@features/Tasks/components/CommentSection';
import StackedVoteBar from '@features/Tasks/components/StackedVoteBar';
import { useAddComment, useToggleCommentLike } from '@features/Tasks/hooks/useComment';
import { fetchComments } from '@features/Tasks/api/commentApi';
import { increaseTaskViewCount } from '@features/Tasks/api/taskApi';

export default function TaskDetailScreenOld({
  route,
  navigation,
