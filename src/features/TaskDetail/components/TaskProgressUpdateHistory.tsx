...
type TimelineBeat = Partial<TaskBeat> & {
  key: string;
  displayText: string;
          ...
          <View style={styles.footer}>
            ...
            {canCheer ? (
              <Ripple
                ...
                onPress={() => onCheerPress?.(beat as TaskBeat)}
              ...
              <Ripple
                radius={22}
                onPress={() => onShareUpdate?.(beat as TaskBeat)}
                style={styles.cheerButton}
              >
                <Icon
                  set="ion"
...
function matchesUpdate(beat: TaskBeat, update: ProgressUpdate) {
...
function findUpdateForBeat(beat: TaskBeat, updates: ProgressUpdate[]) {
