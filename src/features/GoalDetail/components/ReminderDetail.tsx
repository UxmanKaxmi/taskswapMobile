...
import ReminderNoteList from '@features/Goals/components/ReminderNoteList';
import { useRemindersForGoal } from '@features/Home/hooks/useRemindersForGoal';
...
export default function ReminderDetail({ task }: Props) {
  ...
  const { data: reminders, isLoading, isError } = useRemindersForGoal(task.id);
