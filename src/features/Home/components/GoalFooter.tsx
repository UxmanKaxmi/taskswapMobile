...
import { GoalType } from '../types/home';
...
export default function GoalFooter({
  ...
  const ownerMotivationPushCount =
    isOwner && taskDetails?.type === GoalTypeEnum.Motivation
  ...
  return (
    <View>
      ...
      <View style={styles.footer}>
        ...
        ) : taskDetails?.type === GoalTypeEnum.Motivation ? (
        ...
        ) : taskDetails?.type === GoalTypeEnum.Advice ? (
        ...
        ) : taskDetails?.type === GoalTypeEnum.Reminder ? (
          <View style={{ flex: 1 }}>
            {/* OWNER */}
            {isOwner ? (
        ...
        ) : taskDetails?.type === GoalTypeEnum.Decision ? (
