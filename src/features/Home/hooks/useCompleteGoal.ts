// src/features/tasks/api/useCompleteGoal.ts
...
const FIRST_COMPLETION_FEEDBACK_PROMPT_KEY = 'feedback:firstGoalCompletionPromptShown';
...
export function useCompleteGoal() {
  ...
  return useMutation({
    mutationFn: async (taskId: string) => {
      const response = await api.patch(buildRoute.completeGoal(taskId));
